...
export default function LandingPage() {
  return (
    <div className="flex flex-col pt-20">
      {/* ───── Hero ───── */}
      <section className="mt-0 pb-12 space-y-10 md:space-y-15 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6 rounded-xl bg-white/90">
          <Badge variant="outline" className="bg-green-100 text-green-700">
            Split evenly. Simplify life.
          </Badge>
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row justify-center">
            <Button asChild size="lg" className="bg-green-700 text-white hover:bg-green-800 shadow-none">
              <Link to="/dashboard">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-green-600 text-green-600 hover:bg-green-50 shadow"
            >
        ...
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map(({ title, Icon, bg, color, description }) => (
              <Card
                key={title}
                className="flex flex-col items-center space-y-4 p-6 text-center shadow-md"
              >
      ...
      <section className="py-20 gradient">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <Button asChild size="lg" className="bg-green-800 hover:opacity-90 shadow-xl">
            <Link to="/dashboard">
              Split your first bill
              <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
