...
// `currentUser` is passed as a prop, participants are managed via onParticipantsChange
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {participants.length < 2 && (
          <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent
              className="p-0 bg-white shadow-md rounded-md" // <- Add background and shadow
              align="start"
            >
              <Command>
                <CommandInput
