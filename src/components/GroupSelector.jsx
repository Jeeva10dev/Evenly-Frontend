...
// `groups` is now expected to be passed as a prop or fetched via your own API
export function GroupSelector({ groups = [], onChange, isLoading }) {
  ...
  }, [selectedGroupId, groups, onChange]);
